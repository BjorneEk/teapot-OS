...
inline matrix3x3_t rot_x_mat3x3(float v) {
	return (matrix3x3_t)
	{
		.r1 = {1.0f,   0.0f,    0.0f},
		.r2 = {0.0f, cos(v), -sin(v)},
...
inline matrix3x3_t rot_y_mat3x3(float v) {
	return (matrix3x3_t)
	{
		.r1 = { cos(v), 0.0f, sin(v)},
		.r2 = {   0.0f, 1.0f,   0.0f},
...
inline matrix3x3_t rot_z_mat3x3(float v) {
	return (matrix3x3_t)
	{
		.r1 = {cos(v), -sin(v), 0.0f},
		.r2 = {sin(v),  cos(v), 0.0f},
...
inline matrix4x4_t rot_x_mat4x4(float v) {
	return (matrix4x4_t)
	{
...
inline matrix4x4_t rot_y_mat4x4(float v) {
	return (matrix4x4_t)
	{
...
inline matrix4x4_t rot_z_mat4x4(float v) {
	return (matrix4x4_t)
	{
...
inline matrix4x4_t translation_matrix(vec3d_t pos) {
	return (matrix4x4_t)
	{
...
inline matrix4x4_t scaling_matrix(vec3d_t xyz_scale) {
	return (matrix4x4_t)
	{
...
inline matrix4x4_t projection_matrix(float near, float far, float fov, float ar){
